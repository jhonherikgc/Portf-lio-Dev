...
const skillsData: Skill[] = [
  ...
  { id: 'Node Js', image: nodejsIcon, hoverText: 'Nodejs o motor V8 do JavaScript', clickText: 'O Nodejs pode executar o JavaScript fora da web, trabalhando ao lado do servidor (SSR). Ainda com pouco experiência, procuro aprender mais e mais sobre Nodejs. Com o Nodejs tenho mais escalabilidades de consumir APIs e manter meu projeto conectado com o backend / base de dados.', expText:'+- 1 mes.'},
